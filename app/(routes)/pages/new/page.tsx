...
// typese
import type { ImageType, PageType } from "@/lib/types";
                ...
                <Label
                  ...
                  className={classNames(
                    disableBtn
                      ...
                      : "",
                    coverPicture ? "active" : "",
                    "text-primary text-center font-semibold bg-white block rounded-sm shadow-md cursor-pointer hover:scale-[1.025] choose-picture-label"
                  )}
                >
                  {coverPicture ? (
                    <AiOutlineUserSwitch size={30} className="mx-auto" />
